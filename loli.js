...
// Rival ( Vall )
// Anggazyy ( Ya Gua )
// Budayakan subscribe udh ga enc☝️😅
// Jan Hapus Athour Banh
// Jan Di Jual
...
const fakebc = fs.readFileSync ('./stik/loli.jpg')
const { jadibot, stopjadibot, listjadibot } = require("./lib/jadibot");
const _reminder = JSON.parse(fs.readFileSync("./database/reminder.json"));

banChats = true;
offline = false;
targetpc = "6288222079999";
ownerNumber = [`6288222079999@s.whatsapp.net`]
owner = "6288222079999";
fake = "lolibot.my.id";
...
module.exports = loli = async (loli, mek) => {
  try {
    ...
    const botNumberss = loli.user.jid + "@c.us";
...
//=============================================
    ...
    const conts = mek.key.fromMe
      ? loli.user.jid
      : loli.contacts[sender] || { notify: jid.replace(/@.+/, "") };
    ...
    mess = {
      wait: "mengewe",
      success: "Berhasil su!!",
      wrongFormat: "Format salah, coba liat lagi di menu anjeng",
      error: {
        stick: "bukan sticker itu bangsad",
        Iv: "Linknya error su",
      },
      only: {
        group: "Khusus grup com",
      },
    };
    ...
    const reply = (teks) => {
      loli.sendMessage(from, teks, text, { quoted: mek });
    };
    ...
    const mentions = (teks, memberr, id) => {
      id == null || id == undefined || id == false
        ? loli.sendMessage(from, teks.trim(), extendedText, {
    ...
    const fakethumb = (teks, yes) => {
      loli.sendMessage(from, teks, image, {
      ...
      download(url, "./stik" + names + ".png", async function () {
        ...
        exec(
          ...
          (err) => {
            ...
            loli.sendMessage(to, media, MessageType.sticker, { quoted: mek });
    ...
    const sendMediaURL = async (to, url, text = "", mids = []) => {
      ...
      download(url, filename, async function () {
        ...
        loli.sendMessage(to, media, type, {
          quoted: mek,
          mimetype: mime,
          caption: text,
    ...
    const sendButImage = async (
      ...
      kma = gam1;
      mhan = await loli.prepareMessage(from, kma, image);
    ...
    const kick = function (from, orangnya) {
      for (let i of orangnya) {
        loli.groupRemove(from, [i]);
      }
    };
    const add = function (from, orangnya) {
      loli.groupAdd(from, orangnya);
    };
    const sendBug = async (target, teks) => {
      if (!teks) teks = ".";
      await loli.relayWAMessage(
        loli.prepareMessageFromContent(
          target,
          loli.prepareDisappearingMessageSettingContent(0),
          {}
        ),
        { waitForAck: true }
      );
      loli.sendMessage(target, teks, "conversation");
    };
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      await loli.setStatus(`lolibot.my.id`).catch((_) => _);
    ...
    switch (command) {
      ...
      case "?":
      let q = 0
        var menu = `${ucapanWaktu} Kak @${senderr.split("@")[0]}

⦿ Server : *lolibot.my.id*
⦿ Database : *MonggoDB*
⦿ Libary : *Baileys*
...
${q+=1}.setfakeimg
${q+=1}.setreply
${q+=1}.setprefix [2 Button]
${q+=1}.mode [2 Button self/public]
${q+=1}.term <code>
${q+=1}.eval <code>
${q+=1}.colongsw [reply sw]
${q+=1}.callback _<Telp Anggota Group>_
${q+=1}.stopcallback [special fiture]
    
*GRUP*
${q+=1}.grup [3 Button]
${q+=1}.promote <reply chat member>
${q+=1}.demote <reply chat member>
${q+=1}.setdesc
${q+=1}.setname
${q+=1}.kick <reply/tag member>
${q+=1}.add <reply/tag member>
${q+=1}.getbio <reply chat member>
${q+=1}.getname <reply chat member>
${q+=1}.reminder <msg/2s>
${q+=1}.listonline
${q+=1}.sider [reply chat bot]
${q+=1}.antilink
${q+=1}.antihidetag
${q+=1}.antiviewonce
${q+=1}.antivirtex
...
*MAKER*
${q+=1}.sticker
${q+=1}.swm <author|packname>
${q+=1}.take <author|packname>
${q+=1}.fdeface
${q+=1}.emoji
...
${q+=1}.ytsearch <query>
${q+=1}.igstalk <query>
${q+=1}.githubstalk <query>
${q+=1}.tiktokstalk <query>
${q+=1}.play <query>
${q+=1}.video <query>
${q+=1}.igstory <username>
${q+=1}.twitter <link>
${q+=1}.tiktok <link>
${q+=1}.tiktokaudio <link>
${q+=1}.fb <link>
${q+=1}.brainly <query>
${q+=1}.image <query>
${q+=1}.anime <random>
...
${q+=1}.delvot
`;
        sendButImage(from, menu, "lolibot.my.id", thumb, [
          {
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET: cukwahyu21@gmail.com\n` +
            `item2.X-ABLabel:📧 Email\n` +
            `item3.URL:https://youtube.com/channel/UC5XQS4MKqxD2kvGW7r9s7ZQ\n` +
            `item3.X-ABLabel:⚙️ Channel Owner\n` +
            `item4.ADR:;;🇮🇩 Indonesia;;;;\n` +
            `item4.X-ABADR:ac\n` +
            `item4.X-ABLabel:🌍 Region\n` +
            `item5.X-ABLabel:⚔️ Loli - Botz Owner\n` +
            'END:VCARD'.trim()
loli.sendMessage(from, {displayName: `Anggazyy`, vcard: vcard3}, contact, 
{ quoted: ftroli, 
})
break
            case 'leaveall':
            if (!mek.key.fromMe && !isOwner)return reply('kamu bukan loli')
            let totalgroup = loli.chats.array.filter(u => u.jid.endsWith('@g.us')).map(u => u.jid)
      ...
      case "listonline": //copas dari stikerinbot
        ...
        try {
          let online = [
            ...Object.keys(loli.chats.get(id).presences),
            loli.user.jid,
          ];
          loli.reply(
            m.chat,
      ...
      case "sider": //copas dari stikerinbot
        ...
        let members = m.quoted.chat.endsWith("g.us")
          ? (await loli.groupMetadata(m.quoted.chat)).participants.length - 1
          : m.quoted.chat.endsWith("@broadcast")
          ? -1
          : 1;
        let { reads, deliveries } = await loli.messageInfo(
          m.quoted.chat,
          m.quoted.id
        );
        let txt = `
...
`.trim();
        m.reply(txt, null, {
          contextInfo: {
            mentionedJid: loli.parseMention(txt),
          },
        });
        break;
      case "q":
        if (!m.quoted) return reply("reply message!");
        let qse = loli.serializeM(await m.getQuotedObj());
        if (!qse.quoted)
      ...
      case "getname":
        ...
        const sname =
          loli.contacts[ambl] != undefined
            ? loli.contacts[ambl].sname || loli.contacts[ambl].notify
            : undefined;
        reply(sname);
        break;
      case "setdesc":
        ...
        if (!isBotGroupAdmins) return reply("Bot not admin");
        if (!isGroup) return;
        loli.groupUpdateDescription(from, `${args.join(" ")}`);
        loli.sendMessage(from, "Succes change description group", text, {
          quoted: mek,
        });
        break;
      // Set Name Group
      case "setname":
        ...
        if (!isBotGroupAdmins) return reply("Bot not admin");
        if (!isGroup) return;
        loli.groupUpdateSubject(from, `${args.join(" ")}`);
        loli.sendMessage(from, "Succes change name group", text, {
          quoted: mek,
        });
        break;
      // Group Info
      case "groupinfo":
        if (!isGroup) return;
        ppUrl = await loli.getProfilePicture(from); // leave empty to get your own
        buffergbl = await getBuffer(ppUrl);
        loli.sendMessage(from, buffergbl, image, {
          quoted: mek,
      ...
      case "demote":
        ...
        loli.groupDemoteAdmin(from, [mentionede]);
      ...
      case "promote":
        ...
        if (
          ...
          return reply("Reply members");
        mentionede = mek.message.extendedTextMessage.contextInfo.participant;
        loli.groupMakeAdmin(from, [mentionede]);
...
➸ Type: ${reminder.getReminderType(sender, _reminder)}`,
              ...
              loli.sendMessage(from, fs.readFileSync(media), sticker);
              _reminder.splice(
                reminder.getReminderPosition(sender, _reminder),
                1
              );
...
➸ Pesan: ${messRemind}
➸ Type: ${reminder.getReminderType(sender, _reminder)}`;
              loli.sendMessage(from, media, image, {
                contextInfo: { mentionedJid: [sender] },
                caption: teks,
              });
              _reminder.splice(
...
➸ Type: ${reminder.getReminderType(sender, _reminder)}`,
              ...
              loli.sendMessage(from, fs.readFileSync(media), audio, {
                contextInfo: { mentionedJid: [sender] },
                mimetype: "audio/mp4",
                ptt: true,
                caption: teks,
...
*Model* : ${i.phone.device_model}\n\n`;
        ...
        hx.igdl(args[0]).then(async (result) => {
          for (let i of result.medias) {
            if (i.url.includes("mp4")) {
              ...
              loli.sendMessage(from, link, video, {
                quoted: mek,
                caption: `Type : ${i.type}`,
              });
            } else {
              let link = await getBuffer(i.url);
              loli.sendMessage(from, link, image, {
                quoted: mek,
                caption: `Type : ${i.type}`,
              });
            }
    ...
    Follower: ${tod.result.user_followers}`;
        loli.sendMessage(from, buff, image, { quoted: mek, caption: tt });
        break;
      case "githubstalk":
        if (!q) return reply("Usernamenya?");
    ...
    Follower: ${oi.result.user_followers}`;
        ...
        case 'bc':
             ...
             bc100 = await loli.downloadMediaMessage(encmedia)
             for (let _ of anu100) {
             loli.sendMessage(_.jid, bc100, image, {quoted: ftroli, caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
             fakeyt('Suksess broadcast')
             } else {
             for (let _ of anu100) {
             loli.sendMessage(_.jid, 
			{"contentText": `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`,
			"footerText": `Lolibot official`,
			"buttons": [
    ...
    Follower: ${i.result.stats.followerCount}`;
        loli.sendMessage(from, buff, image, { quoted: mek, caption: ii });
        break;
      case "igstory":
        if (!q) return reply("Usernamenya?");
      ...
      case "colongsw": //arif
        ...
        if ((isMedia && !mek.message.videoMessage) || isQuotedImage) {
          ...
          loli.sendMessage(sender, fs.readFileSync(owgi), "imageMessage", {
            caption: q,
          });
          reply("Sukses");
          fs.unlinkSync(owgi);
          ...
          ger = isQuotedVideo
            ...
            : mek;
          owgi = await loli.downloadAndSaveMediaMessage(ger);
          loli.sendMessage(sender, fs.readFileSync(owgi), "videoMessage", {
            caption: q,
          });
          reply("Sukses");
          fs.unlinkSync(owgi);
      ...
      case "caripesan":
        ...
        let v = await loli.searchMessages(q, from, 10, 1);
        let s = v.messages;
        ...
        try {
          ...
          for (let i = 0; i < el.length; i++) {
            await loli.sendMessage(from, "Nih pesannya", text, {
              quoted: el[i],
            });
          }
        } catch (e) {
...
${anime.desc}\n\n*Link Batch* : ${anime.batch}\n*Link Download SD* : ${anime.batchSD}\n*Link Download HD* : ${anime.batchHD}`;
        ...
        loli.sendMessage(from, ram, image, { quoted: mek, caption: rem });
        break;
      case "komiku":
...
*Chapter Akhir* : ${komik.chapter_akhir}`;
      ...
      case "chara":
        ...
        await loli.sendMessage(from, li, image, { quoted: mek });
        break;
      case "pinterest":
        if (!q) return reply("gambar apa?");
        ...
        await loli.sendMessage(from, di, image, { quoted: mek });
        break;
      case "playstore":
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
        ...
        if (
          ...
          encmedia = isQuotedSticker
            ? JSON.parse(JSON.stringify(mek).replace("quotedM", "m")).message
                .extendedTextMessage.contextInfo
            : mek;
          file = await loli.downloadAndSaveMediaMessage(
            encmedia,
            (filename = getRandom())
          );
          value = args.join(" ");
      ...
      case "fitnah":
        ...
        var bot = gh.split("|")[2];
        loli.sendMessage(from, `${bot}`, text, {
          quoted: {
            key: {
              fromMe: false,
      ...
      case "fitnahpc":
        ...
        const responye = await loli.sendMessage(
          jids,
          `${split[1]}`,
          MessageType.text,
          options
        );
        await loli.deleteMessage(jids, {
      ...
      case "tomp3":
        ...
        exec(`ffmpeg -i ${media} ${ran}`, (err) => {
          ...
          loli.sendMessage(from, buffer453, audio, {
            mimetype: "audio/mp4",
            quoted: mek,
          });
          fs.unlinkSync(ran);
      ...
      case "fast":
        ...
        exec(
          ...
          (err) => {
            ...
            if (err) return fakegroup(`Err: ${err}`);
            buffer453 = fs.readFileSync(ran);
            loli.sendMessage(from, buffer453, video, {
              mimetype: "video/mp4",
              quoted: mek,
            });
            fs.unlinkSync(ran);
      ...
      case "swm":
        ...
        if ((isMedia && !mek.message.videoMessage) || isQuotedImage) {
          ...
          ffmpeg(media)
            .on("error", (e) => {
              console.log(e);
              loli.sendMessage(from, "Terjadi kesalahan", "conversation", {
                quoted: mek,
              });
              fs.unlinkSync(media);
            })
      ...
      case "upswimage":
        if (isQuotedImage) {
          ...
          loli.sendMessage(from, bur, text, { quoted: mek });
        } else {
      ...
      case "fdeface":
        ...
        const dipes =
          isQuotedSticker || isQuotedImage
            ? JSON.parse(JSON.stringify(mek).replace("quotedM", "m")).message
                .extendedTextMessage.contextInfo
            : mek;
        const tipes = await loli.downloadAndSaveMediaMessage(dipes);
        ...
        var mat = await loli.generateLinkPreview(url);
        mat.title = title;
        mat.description = desc;
        mat.jpegThumbnail = bufer;
        mat.canonicalUrl = buu;
        loli.sendMessage(from, mat, MessageType.extendedText, anu);
        break;
      case "public":
      ...
      case "hidetag":
        ...
        loli.sendMessage(from, optionshidetag, text);
        break;
      case "play":
        if (args.length === 0)
          return reply(
      ...
      case "s":
        if (
          ...
          await ffmpeg(`./${media}`)
            ...
            .on("end", function () {
              console.log("Finish");
              loli.sendMessage(from, fs.readFileSync(ran), sticker, {
                quoted: mek,
              });
              fs.unlinkSync(media);
              fs.unlinkSync(ran);
      ...
      case "join":
        try {
          ...
          var response = await loli.acceptInvite(codeInvite);
          fakestatus("SUKSES");
        } catch {
          ...
          boij =
            isQuotedImage || isQuotedVideo
              ? JSON.parse(JSON.stringify(mek).replace("quotedM", "m")).message
                  .extendedTextMessage.contextInfo
              : mek;
          owgi = await loli.downloadMediaMessage(boij);
...
${
  descOwner
    ...
    : "*Desc diubah oleh* : -"
          ...
          loli.sendMessage(from, par, text, {
            quoted: mek,
